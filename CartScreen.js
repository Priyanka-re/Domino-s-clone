                            ...
                            <View style={{ flexDirection: "row", alignItems: "center" }}>
                                ...
                                <View style={{ marginLeft: 10 }}>
                                    ...
                                    <View style={{ flexDirection: "row", alignItems: "center", marginVertical: 6 }}>
                                        <Text style={{ color: "white", fontSize: 17 }}>{item.size}</Text>
                                        <Text style={{ color: "white", fontSize: 15 }}>
                                            {" "}
                                            | {item.description.substr(0, 23) + '...'}</Text>
                                    </View>
            ...
            {total === 0 ? (
                ...
                <View style={{ height: 200 }}>
                    <View style={{ margin: 10, flexDirection: "row", alignitems: "center" }}>
                        ...
                        <View style={{ marginLeft: 10 }}>
                            <Text style={{ fontWeight: "bold", fontSize: 15 }}>Delivering To Home</Text>
                            <Text style={{ width: 200, fontSize: 16, marginTop: 3, color: "gray" }}>St #103 San Francisco </Text>
                        </View>
                    </View>
                    ...
                    <View style={{ margin: 10, flexDirection: "row", alignitems: "center" }}>
                        ...
                        <View style={{ marginLeft: 10 }}>
                            ...
                            <Text style={{ width: 200, fontSize: 16, marginTop: 3, color: "gray" }}>Pay Via Cash</Text>
                        </View>
                    </View>
                    <Pressable
                        onPress={placeOrder}
                        ...
                        <Text style={{ textAlign: "center", color: "white", fontWeight: "bold" }}>Place Order</Text>
                    </Pressable>
                </View>
            )}
