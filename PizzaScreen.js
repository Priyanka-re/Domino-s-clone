...
const PizzaScreen = () => {
    ...
    const total = cart.map((item) => Number(item.price * item.quantity)).reduce((prev, curr) => prev + curr, 0)
        ...
        <SafeAreaView>
            ...
            {total === 0 ? (
                ...
                style={{
                    ...
                    <Text style={{textAlign:"center",fontweight:"bold",fontsize:16,color:"white"}}>Go To Cart</Text>
                </Pressable>
            )}
        </SafeAreaView>
    );
